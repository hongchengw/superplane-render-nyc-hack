...
2. **Acceptance Criteria** — numbered checklist of testable requirements
3. **Files Likely Affected** — list with brief rationale
4. **Implementation Plan** — ordered numbered steps
5. **Edge Cases & Risks** — anything that could break
...
PR_RESPONSE=$(curl -sf -X POST \\
  ...
  -d "$(jq -n \\
    ...
    --arg head "$BRANCH" \\
    --arg body "### Software Factory Auto-Implementation \\\\n\\\\n**Issue**: #$ISSUE_NUMBER  \\\\n**Branch**: \\\`$BRANCH\\\`  \\\\n**Validation**: $VALIDATION  \\\\n**Preview**: $PREVIEW_URL\\\\n\\\\n---\\\\n*Generated by [SuperPlane Software Factory](https://superplane.com)*" \\
